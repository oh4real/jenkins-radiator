...
/**
 * @ngdoc function
 * @name jenkinsRadiatorApp.controller:AboutCtrl
 * @description
 * # AboutCtrl
 * Controller of the jenkinsRadiatorApp
 */
angular.module('jenkinsRadiatorApp')
    .controller('RadiatorController', function($scope, $routeParams, $interval, $http) {
        ...
        var getProjectData = function() {
            ...
            $http.get(url.replace(':project', $routeParams.project), {
                cache: false
